...
public class AirLineTests extends AirLineApis {
    ...
    public void createPostAirLineId() {
        ...
        Map<String, Object> createAirLinePayload = Payloads.postCreateAirLineUsingMap("19766001", "Sri Lankan Airways", "Sri Lanka", "https://upload.wikimedia.org/wikipedia/en/thumb/9/9b/Qatar_Airways_Logo.svg/sri_lanka.png",
